...
- [adversarial-review](./adversarial-review/) - Runs a three-role adversarial code review: a hostile Blue Team that must attach evidence chains, an independent Third Party that distrusts both sides' documents and hunts defects introduced *by the fixes*, and a neutral adjudicator that accepts or rejects each finding. Use before releases or refactors. *By [@RevolutionLA](https://github.com/RevolutionLA)*
